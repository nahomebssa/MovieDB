...
public class Actor implements models.IModel {
    
    private static final String INSERT_FORMAT = "INSERT INTO Actor VALUES(?, ?, ?)";
    ...
    public void insertRecord(PreparedStatement pstmt, String[] values) {
        ...
        if (values.length != NUMBER_OF_COLUMNS) {
            System.err.println("Actor.insertRecord: only " + NUMBER_OF_COLUMNS + " values needed");
            return;
        }
