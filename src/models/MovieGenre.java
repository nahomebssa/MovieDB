...
public class MovieGenre implements models.IModel {
    private static final String INSERT_FORMAT = "INSERT INTO Movie_genre VALUES(?, ?)";
    ...
    public void insertRecord(PreparedStatement pstmt, String[] values) {
        ...
        if (values.length != NUMBER_OF_COLUMNS) {
            System.err.println("MovieGenre.insertRecord: only " + NUMBER_OF_COLUMNS + " values needed");
            return;
        }
